...
func buildProviderRequestURLAndTLS(
	...
	lookup := backendTransportLookup(ctx)
	if lookup == nil {
...
func backendTransportLookup(ctx PolicyCtx) *backendtransport.BackendTransportLookup {
	if ctx.BackendTransportLookup != nil {
		return ctx.BackendTransportLookup
	}
	if ctx.Collections == nil {
		return nil
	}
	return backendtransport.NewBackendTransportLookup(
		ctx.Collections.ConfigMaps,
