...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OIDCDiscovery) DeepCopyInto(out *OIDCDiscovery) {
	*out = *in
	if in.BackendRef != nil {
		in, out := &in.BackendRef, &out.BackendRef
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OIDCDiscovery.
func (in *OIDCDiscovery) DeepCopy() *OIDCDiscovery {
	if in == nil {
		return nil
	}
	out := new(OIDCDiscovery)
